          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              {projects.map((project, index) => {
                return (
                  <SwiperSlide key={index} className="w-full">
                    <div className="h-[460px] relative gfroup flex justify-center items-center bg-pink-50/20">
                      {/* overlay */}
              ...
              <WorkSliderBtns containerStyles="flex gap-2 absolute right-0 bottom-[calc(50%_-_22px)]
               ...
               hover:bg-accent-hover text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition" />
            </Swiper>
          </div>
        </div>
      </div>
